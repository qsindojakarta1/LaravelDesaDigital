            ...
            <div class="card">
                <div class="card-body">
                    <div class="site-tile text-center mb-60">
                        <span class="sub-title">Grafik Jenis Kelamin</span>
                        <h2 class="mb-0">Grafik Pertumbuhan Penduduk {{ getDesaFromUrl()->nama_desa }} Berdasarkan Jenis Kelamin</h2>
                    </div>
...
<script>
    const getJenisKelamin = async () => {
        try {
            let piedata = await fetch(`/api/jenis_kelamin`, {
                method: 'post',
                headers: {
