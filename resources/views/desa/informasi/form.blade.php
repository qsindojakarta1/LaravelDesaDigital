    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select name="desa_id" id="desa_id" class="form-control @error('desa_id') is-invalid  @enderror">
                ...
                <option @if($informasi->desa_id == $desa->id) selected @endif value="{{ $desa->id }}">{{ $desa->nama_desa }} - {{ $desa->sub_domain }}</option>
                @endforeach
            </select>
            @error('desa_id')
            <div class="invalid-feedback">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select name="kategori_informasi_id" id="kategori_informasi_id" class="form-control @error('kategori_informasi_id') is-invalid  @enderror">
                ...
                <option @if($informasi->kategori_informasi_id == $data->id) selected @endif value="{{ $data->id }}">{{ $data->nama }}</option>
                @endforeach
            </select>
