...
class CetakSuratController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        PengajuanWarga::create([
            ...
            'status_perkawinan' => $warga->status_perkawinan->nama,
            'pekerjaan' => $warga->pekerjaan->nama,
            'golongan_darah' => $warga->golongan_darah->nama
        ]);
        switch ($request->permohonan_surat_id) {
            case 1:
                ...
                try {
                    PermohonanSuratSkck::create([
                        ...
                        'pendidikan' => $warga->pendidikan->find($request->pendidikan)->nama,
                        'pekerjaan' => $warga->pekerjaan->find($request->pekerjaan)->nama,
                    ]);
                    $body = array(
                        'nama' => $warga->nama_warga,
                        'no_ktp' => $warga->nik,
            ...
            case 2:
                ...
                try {
                    ...
                    $body = array(
                        ...
                        'agama' => $warga->agama->nama,
                        'pendidikan' => $warga->pendidikan->nama,
                        'pekerjaan' => $warga->pekerjaan->nama,
                    );
                    $array = array_merge(
                        $this->header($warga, [
            ...
            case 4:
                ...
                try {
                    ...
                    $body = array(
                        ...
                        'pendidikan' => $warga->pendidikan->nama,
                        'pekerjaan' => $warga->pekerjaan->nama,
                        'gol_darah' => $warga->golongan_darah->nama,
                    );
                    $array = array_merge(
                        $this->header($warga, [
                            'judul_surat' => 'Permohonan Surat Izin Keramaian',
            ...
            case 5:
                ...
                try {
                    PermohonanSuratKuasa::create([
                        ...
                        'pekerjaan_pen' => Pekerjaan::find($request->pekerjaan_pen)->nama,
                    ]);
                    $body = array(
                        ...
                        'pekerjaanpemberi_kuasa' => $warga->pekerjaan->nama,
                        ...
                        'pekerjaanpenerima_kuasa' => Pekerjaan::find($request->pekerjaan_pen)->nama,
            ...
            case 9:
                ...
                $array_ayah = [
                    ...
                    'd_agama_ayah' => $ayah->agama->nama,
                    'd_pekerjaan_ayah' => $ayah->pekerjaan->nama,
                ...
                $array_ibu = [
                    ...
                    'd_agama_ibu' => $ibu->agama->nama,
                    'd_pekerjaan_ibu' => $ibu->pekerjaan->nama,
            ...
            case 13:
                ...
                try {
                    ...
                    $body = [
                        ...
                        'pekerjaanibu' => $ibu->pekerjaan->nama,
                        ...
                        'pekerjaanayah' => $ayah->pekerjaan->nama,
                        ...
                        'form_pekerjaanpelapor' => $pelapor->pekerjaan->nama,
                        ...
                        'pekerjaanpelapor' => $pelapor->pekerjaan->nama,
                        ...
                        'pekerjaansaksi1' => $saksi_satu->pekerjaan->nama ?? 'Kosong',
                        ...
                        'pekerjaansaksi2' => $saksi_dua->pekerjaan->nama ?? 'Kosong',
            ...
            case 14:
                ...
                try {
                    ...
                    $body = [
                        ...
                        'form_pekerjaan' => $pihak->pekerjaan->nama,
                        'form_keterangan' => $request->keterangan,
            ...
            case 16:
                ...
                try {
                    PermohonanSuratBedaIdentitas::create([
                        ...
                        'agama_identitas' => Agama::find($request->agama_identitas)->nama,
                        'pekerjaan_identitas' => Pekerjaan::find($request->pekerjaan_identitas)->nama,
                    ...
                    $body = [
                        ...
                        'form_pekerjaan' => Pekerjaan::find($request->pekerjaan_identitas)->nama,
                        'form_agama' => Agama::find($request->agama_identitas)->nama,
        ...
        try {
            ...
            $templateProcessor->setImageValue('logo', array('path' => public_path('storage/' . Desa::find(auth()->user()->desa_id)->light_logo), 'width' => 50, 'height' => 50, 'ratio' => false));
    ...
    public function update(Request $request, $id)
    {
            ...
            case 1:
                ...
                try {
                    PermohonanSuratSkck::create([
                        'permohonan_surat_id' => $id,
                        'keperluan' => $request->keperluan,
                        'pendidikan' => Pendidikan::find($request->pendidikan)->nama,
                        'pekerjaan' => Pekerjaan::find($request->pekerjaan)->nama,
                    ]);
        ...
        try {
            ...
            $templateProcessor->setValues($array);
            // dd(asset('storage/'.Desa::find(auth()->user()->desa_id)->light_logo));
            $templateProcessor->setImageValue('logo', array('path' => public_path('storage/' . Desa::find(auth()->user()->desa_id)->light_logo), 'width' => 100, 'height' => 100, 'ratio' => false));
            header('Content-Disposition: attachment; filename=' . $nama_file);
